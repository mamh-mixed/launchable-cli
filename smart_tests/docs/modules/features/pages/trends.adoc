...
The *Trends* page shows aggregate info about your test runs, including average test session duration, test session frequency, and how often sessions fail.
